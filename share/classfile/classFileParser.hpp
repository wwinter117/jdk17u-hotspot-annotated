...
private:
    ...
    void set_class_sde_buffer(const char *x, int len) {
        _sde_buffer = x;
        _sde_length = len;
    }
    ...
    inline void guarantee_property(bool b, const char *msg, TRAPS) const {
        if (!b) {
            classfile_parse_error(msg, THREAD);
            return;
        }
    }
    ...
    inline void guarantee_property(bool b,
                                   ...
                                   TRAPS) const {
        if (!b) {
            classfile_parse_error(msg, index, THREAD);
            return;
        }
    }
    ...
    inline void guarantee_property(bool b,
                                   ...
                                   TRAPS) const {
        if (!b) {
            classfile_parse_error(msg, name, THREAD);
            return;
        }
    }
    ...
    inline void guarantee_property(bool b,
                                   ...
                                   TRAPS) const {
        if (!b) {
            classfile_parse_error(msg, index, name, THREAD);
            return;
        }
    }

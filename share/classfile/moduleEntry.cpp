...
void ModuleEntryTable::patch_javabase_entries(Handle module_handle) {
    if (module_handle.is_null()) {
        ...
        JAVA_BASE_NAME
        "'s definition, invalid java.lang.Module");
    }
...
void ModuleEntry::print(outputStream *st) {
    ...
    " name %s module "
    PTR_FORMAT
    " loader %s version %s location %s strict %s next "
    PTR_FORMAT,
            p2i(this),

...
public:
    ...
    static VerificationType double2_type() { return VerificationType(Double_2nd); }
    ...
    static VerificationType reference_check() { return VerificationType(ReferenceQuery); }

    static VerificationType category1_check() { return VerificationType(Category1Query); }

    static VerificationType category2_check() { return VerificationType(Category2Query); }

    static VerificationType category2_2nd_check() { return VerificationType(Category2_2ndQuery); }
    ...
    static VerificationType uninitialized_this_type() { return uninitialized_type(BciForThis); }

...
public:
    ...
    static void init_dumptime_info(InstanceKlass *k)

    NOT_CDS_RETURN;

    static void remove_dumptime_info(InstanceKlass *k)
    ...
    static void add_lambda_proxy_class(InstanceKlass *caller_ik,
                                       ...
                                       Symbol *instantiated_method_type, TRAPS)
    ...
    static bool check_linking_constraints(Thread *current, InstanceKlass *klass)
    ...
    static void print_shared_archive(outputStream *st, bool is_static = true)

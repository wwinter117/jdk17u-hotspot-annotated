...
JRT_LEAF(void, ZBarrierSetRuntime::clone(oopDesc
...
JRT_END
        ...
        address
ZBarrierSetRuntime::load_barrier_on_oop_field_preloaded_addr(DecoratorSet
decorators) {
if (
...
weak_load_barrier_on_phantom_oop_field_preloaded_addr();

} else {
return

load_barrier_on_phantom_oop_field_preloaded_addr();
...
weak_load_barrier_on_weak_oop_field_preloaded_addr();

} else {
return

load_barrier_on_weak_oop_field_preloaded_addr();
...
weak_load_barrier_on_oop_field_preloaded_addr();

} else {
return

load_barrier_on_oop_field_preloaded_addr();

...
ZLoadBarrierStubC2 *
ZLoadBarrierStubC2::create(const MachNode *node, Address ref_addr, Register ref, Register tmp, uint8_t barrier_data) {
    ZLoadBarrierStubC2 *const stub = new(Compile::current()->comp_arena()) ZLoadBarrierStubC2(node, ref_addr, ref, tmp,
                                                                                              barrier_data);
...
ZLoadBarrierStubC2::ZLoadBarrierStubC2(const MachNode *node, Address ref_addr, Register ref, Register tmp,
...
void ZBarrierSetC2::emit_stubs(CodeBuffer &cb) const {
    ...
    GrowableArray < ZLoadBarrierStubC2 * > *
    const stubs = barrier_set_state()->stubs();
...
void ZBarrierSetC2::clone_at_expansion(PhaseMacroExpand *phase, ArrayCopyNode *ac) const {
    ...
    if (ac->is_clone_array() && ary_ptr != NULL) {
        ...
        Node *call = phase->make_leaf_call(ctrl, mem, call_type, copyfunc_addr, copyfunc_name, raw_adr_type,

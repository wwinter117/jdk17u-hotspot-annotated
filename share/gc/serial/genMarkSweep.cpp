...
void GenMarkSweep::mark_sweep_phase1(bool clear_all_softrefs) {
    ...
    GCTraceTime(Info, gc, phases)
    tm("Phase 1: Mark live objects", _gc_timer);
    ...
    // Process reference objects found during marking
    {
        ...
        tm_m("Reference Processing", gc_timer());
    ...
    {
        GCTraceTime(Debug, gc, phases)
        tm_m("Weak Processing", gc_timer());
        WeakProcessor::weak_oops_do(&is_alive, &do_nothing_cl);
    }

    {
        GCTraceTime(Debug, gc, phases)
        tm_m("Class Unloading", gc_timer());
    ...
    {
        GCTraceTime(Debug, gc, phases)
        tm_m("Report Object Count", gc_timer());
...
void GenMarkSweep::mark_sweep_phase2() {
    ...
    GCTraceTime(Info, gc, phases)
    tm("Phase 2: Compute new object addresses", _gc_timer);
...
void GenMarkSweep::mark_sweep_phase3() {
    ...
    GCTraceTime(Info, gc, phases)
    tm("Phase 3: Adjust pointers", gc_timer());
...
void GenMarkSweep::mark_sweep_phase4() {
    ...
    GCTraceTime(Info, gc, phases)
    tm("Phase 4: Move objects", _gc_timer);

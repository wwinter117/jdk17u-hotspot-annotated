...
ArchDesc::ArchDesc()
    ...
    _ADL_file._name = NULL;
    _ADL_file._fp = NULL;
    // Machine dependent output files
    _DFA_file._name = NULL;
    _DFA_file._fp = NULL;
    _HPP_file._name = NULL;
    _HPP_file._fp = NULL;
    _CPP_file._name = NULL;
    _CPP_file._fp = NULL;
    _bug_file._name = "bugs.out";
    _bug_file._fp = NULL;
...
bool ArchDesc::verify() {
    ...
    if (_register) assert(_register->verify(), "Register declarations failed verification");
    if (!_quiet_mode)
        fprintf(stderr, "\n");

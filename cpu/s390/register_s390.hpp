...
constexpr Register
noreg = as_Register(NOREG_ENCODING);
...
Z_R9 = as_Register(9);
constexpr Register
Z_R10 = as_Register(10);
constexpr Register
Z_R11 = as_Register(11);
constexpr Register
Z_R12 = as_Register(12);
constexpr Register
Z_R13 = as_Register(13);
constexpr Register
Z_R14 = as_Register(14);
constexpr Register
Z_R15 = as_Register(15);
...
constexpr FloatRegister
Z_F0 = as_FloatRegister(0);
constexpr FloatRegister
Z_F1 = as_FloatRegister(1);
constexpr FloatRegister
Z_F2 = as_FloatRegister(2);
constexpr FloatRegister
Z_F3 = as_FloatRegister(3);
constexpr FloatRegister
Z_F4 = as_FloatRegister(4);
constexpr FloatRegister
Z_F5 = as_FloatRegister(5);
constexpr FloatRegister
Z_F6 = as_FloatRegister(6);
constexpr FloatRegister
Z_F7 = as_FloatRegister(7);
constexpr FloatRegister
Z_F8 = as_FloatRegister(8);
constexpr FloatRegister
Z_F9 = as_FloatRegister(9);
constexpr FloatRegister
Z_F10 = as_FloatRegister(10);
constexpr FloatRegister
Z_F11 = as_FloatRegister(11);
constexpr FloatRegister
Z_F12 = as_FloatRegister(12);
constexpr FloatRegister
Z_F13 = as_FloatRegister(13);
constexpr FloatRegister
Z_F14 = as_FloatRegister(14);
constexpr FloatRegister
Z_F15 = as_FloatRegister(15);
...
public:
    ...
    as_SingleFloatRegister(int encoding) {
...
public:
    ...
    as_DoubleFloatRegister(int encoding) {
...
public:
    ...
    as_QuadFloatRegister(int encoding) {
        assert(encoding < QuadFloatRegister::number_of_registers && ((encoding & 2) == 0),
               "bad quad float register encoding");
...
public:
    ...
    int64_t RXB_mask(int pos) const {
        if (encoding() >= number_of_registers / 2) {
            switch (pos) {
                case 8:
                    return ((int64_t) 0b1000) << 8; // actual bit pos: 36
                case 12:
                    return ((int64_t) 0b0100) << 8; // actual bit pos: 37
                case 16:
                    return ((int64_t) 0b0010) << 8; // actual bit pos: 38
                case 32:
                    return ((int64_t) 0b0001) << 8; // actual bit pos: 39
                default:
                    ShouldNotReachHere();
            }
        }
...
vnoreg = as_VectorRegister(NOREG_ENCODING);

constexpr VectorRegister
Z_V0 = as_VectorRegister(0);
constexpr VectorRegister
Z_V1 = as_VectorRegister(1);
constexpr VectorRegister
Z_V2 = as_VectorRegister(2);
constexpr VectorRegister
Z_V3 = as_VectorRegister(3);
constexpr VectorRegister
Z_V4 = as_VectorRegister(4);
constexpr VectorRegister
Z_V5 = as_VectorRegister(5);
constexpr VectorRegister
Z_V6 = as_VectorRegister(6);
constexpr VectorRegister
Z_V7 = as_VectorRegister(7);
constexpr VectorRegister
Z_V8 = as_VectorRegister(8);
constexpr VectorRegister
Z_V9 = as_VectorRegister(9);
constexpr VectorRegister
Z_V10 = as_VectorRegister(10);
constexpr VectorRegister
Z_V11 = as_VectorRegister(11);
constexpr VectorRegister
Z_V12 = as_VectorRegister(12);
constexpr VectorRegister
Z_V13 = as_VectorRegister(13);
constexpr VectorRegister
Z_V14 = as_VectorRegister(14);
constexpr VectorRegister
Z_V15 = as_VectorRegister(15);
constexpr VectorRegister
Z_V16 = as_VectorRegister(16);
constexpr VectorRegister
Z_V17 = as_VectorRegister(17);
constexpr VectorRegister
Z_V18 = as_VectorRegister(18);
constexpr VectorRegister
Z_V19 = as_VectorRegister(19);
constexpr VectorRegister
Z_V20 = as_VectorRegister(20);
constexpr VectorRegister
Z_V21 = as_VectorRegister(21);
constexpr VectorRegister
Z_V22 = as_VectorRegister(22);
constexpr VectorRegister
Z_V23 = as_VectorRegister(23);
constexpr VectorRegister
Z_V24 = as_VectorRegister(24);
constexpr VectorRegister
Z_V25 = as_VectorRegister(25);
constexpr VectorRegister
Z_V26 = as_VectorRegister(26);
constexpr VectorRegister
Z_V27 = as_VectorRegister(27);
constexpr VectorRegister
Z_V28 = as_VectorRegister(28);
constexpr VectorRegister
Z_V29 = as_VectorRegister(29);
constexpr VectorRegister
Z_V30 = as_VectorRegister(30);
constexpr VectorRegister
Z_V31 = as_VectorRegister(31);

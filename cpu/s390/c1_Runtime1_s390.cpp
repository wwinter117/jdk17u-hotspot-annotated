...
int
StubAssembler::call_RT(Register oop_result1, Register metadata_result, address entry_point, int number_of_arguments) {
...
void Runtime1::generate_unwind_exception(StubAssembler *sasm) {
    ...
    __ asm_assert_mem8_is_zero(in_bytes(JavaThread::exception_oop_offset()), Z_thread, "exception oop already set : "
    FILE_AND_LINE, 0);
    __ asm_assert_mem8_is_zero(in_bytes(JavaThread::exception_pc_offset()), Z_thread, "exception pc already set : "
    FILE_AND_LINE, 0);
...
OopMapSet *Runtime1::generate_code_for(StubID id, StubAssembler *sasm) {
    ...
    switch (id) {
        ...
        case throw_array_store_exception_id: {
            ...
            break;
        case throw_class_cast_exception_id: { // Z_R1_scratch: object
        ...
        case slow_subtype_check_id: {
            ...
            if (UseCompressedOops) {
                assert(Universe::heap() != NULL,
                       "java heap must be initialized to generate partial_subtype_check stub");
            }
        ...
        case monitorenter_id: { // Z_R1_scratch : object
        ...
        case monitorexit_id: { // Z_R1_scratch : lock address
        ...
        case deoptimize_id: { // Args: Z_R1_scratch: trap request

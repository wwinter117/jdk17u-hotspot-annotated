...
LIR_Opr LIRGenerator::result_register_for(ValueType *type, bool callee) {
    ...
    switch (type->tag()) {
        case intTag:
            opr = FrameMap::Z_R2_opr;
            break;
        case objectTag:
            opr = FrameMap::Z_R2_oop_opr;
            break;
        case longTag:
            opr = FrameMap::Z_R2_long_opr;
            break;
        case floatTag:
            opr = FrameMap::Z_F0_opr;
            break;
        case doubleTag:
            opr = FrameMap::Z_F0_double_opr;
            break;
...
void LIRGenerator::do_update_CRC32(Intrinsic *x) {
    ...
    switch (x->id()) {
        ...
        case vmIntrinsics::_updateByteBufferCRC32: {
            ...
            crc.load_item_force(
                    arg1); // We skip int->long conversion here, because CRC32 stub doesn't care about high bits.
...
void LIRGenerator::do_update_CRC32C(Intrinsic *x) {
    ...
    switch (x->id()) {
        ...
        case vmIntrinsics::_updateDirectByteBufferCRC32C: {
            ...
            crc.load_item_force(
                    arg1); // We skip int->long conversion here, because CRC32C stub doesn't care about high bits.
            __ leal(LIR_OprFact::address(a), arg2);

...
void TemplateTable::iop2(Operation op) {
    ...
    switch (op) {
        case add  :
        __ z_ay(Z_tos, __ stackTop());
            __ pop_i();
            break;
        case sub  :
        __ z_sy(Z_tos, __ stackTop());
            __ pop_i();
            __ z_lcr(Z_tos, Z_tos);
            break;
        case mul  :
        __ z_msy(Z_tos, __ stackTop());
            __ pop_i();
            break;
        case _and :
        __ z_ny(Z_tos, __ stackTop());
            __ pop_i();
            break;
        case _or  :
        __ z_oy(Z_tos, __ stackTop());
            __ pop_i();
            break;
        case _xor :
        __ z_xy(Z_tos, __ stackTop());
            __ pop_i();
            break;
        case shl  :
        __ z_lr(Z_tmp_1, Z_tos);
            __ z_nill(Z_tmp_1, 31);  // Lowest 5 bits are shiftamount.
            __ pop_i(Z_tos);
            __ z_sll(Z_tos, 0, Z_tmp_1);
            break;
        case shr  :
        __ z_lr(Z_tmp_1, Z_tos);
            __ z_nill(Z_tmp_1, 31);  // Lowest 5 bits are shiftamount.
            __ pop_i(Z_tos);
            __ z_sra(Z_tos, 0, Z_tmp_1);
            break;
        case ushr :
        __ z_lr(Z_tmp_1, Z_tos);
            __ z_nill(Z_tmp_1, 31);  // Lowest 5 bits are shiftamount.
            __ pop_i(Z_tos);
            __ z_srl(Z_tos, 0, Z_tmp_1);
            break;
        default   :
            ShouldNotReachHere();
            break;
...
void TemplateTable::lop2(Operation op) {
    ...
    switch (op) {
        case add  :
        __ z_ag(Z_tos, __ stackTop());
            __ pop_l();
            break;
        case sub  :
        __ z_sg(Z_tos, __ stackTop());
            __ pop_l();
            __ z_lcgr(Z_tos, Z_tos);
            break;
        case mul  :
        __ z_msg(Z_tos, __ stackTop());
            ...
            break;
        case _and :
        __ z_ng(Z_tos, __ stackTop());
            __ pop_l();
            break;
        case _or  :
        __ z_og(Z_tos, __ stackTop());
            __ pop_l();
            break;
        case _xor :
        __ z_xg(Z_tos, __ stackTop());
            __ pop_l();
            break;
        default   :
            ShouldNotReachHere();
...
void TemplateTable::branch(bool is_jsr, bool is_wide) {
    ...
    if (UseLoopCounter) {
        ...
        if (ProfileInterpreter) {
            ...
            const Address mdo_backedge_counter(mdo, MethodData::backedge_counter_offset() +

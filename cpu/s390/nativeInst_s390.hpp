...
public:
    ...
    static bool is_call_before(address a) {
        ...
        bool b = MacroAssembler::is_load_const_call(a - MacroAssembler::load_const_call_size()) ||// load_const + basr
                 MacroAssembler::is_load_const_from_toc_call(a - MacroAssembler::load_const_from_toc_call_size()) ||
                 // load_const_from_toc + basr
                 MacroAssembler::is_call_far_pcrelative(
                         a - MacroAssembler::call_far_pcrelative_size());         // nop+brasl
        return b;
    }
    ...
    bool is_pcrelative() {
        return MacroAssembler::is_call_far_pcrelative((address)
        this);
    }
};

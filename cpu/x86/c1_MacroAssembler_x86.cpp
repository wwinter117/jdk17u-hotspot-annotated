...
int C1_MacroAssembler::lock_object(Register hdr, Register obj, Register disp_hdr, Register scratch, Label &slow_case) {
    const Register rklass_decode_tmp = LP64_ONLY(rscratch1)
    NOT_LP64(noreg);
...
void C1_MacroAssembler::try_allocate(Register obj, Register var_size_in_bytes, int con_size_in_bytes, Register t1,
...
void C1_MacroAssembler::initialize_header(Register obj, Register klass, Register len, Register t1, Register t2) {
    ...
    Register
    tmp_encode_klass = LP64_ONLY(rscratch1)
    NOT_LP64(noreg);
    if (UseBiasedLocking && !len->is_valid()) {
        ...
        movptr(Address(obj, oopDesc::mark_offset_in_bytes()), (int32_t)(intptr_t)
        markWord::prototype().value());
    }
#ifdef _LP64
...
void C1_MacroAssembler::allocate_object(Register obj, Register t1, Register t2, int header_size, int object_size,
...
void
C1_MacroAssembler::initialize_object(Register obj, Register klass, Register var_size_in_bytes, int con_size_in_bytes,
                                     Register t1, Register t2, bool is_tlab_allocated) {
...
void C1_MacroAssembler::allocate_array(Register obj, Register len, Register t1, Register t2, int header_size,
                                       Address::ScaleFactor f, Register klass, Label &slow_case) {
    assert(obj == rax, "obj must be in rax, for cmpxchg");
...
void C1_MacroAssembler::inline_cache_check(Register receiver, Register iCache) {
    ...
    Register
    tmp_load_klass = LP64_ONLY(rscratch2)
    NOT_LP64(noreg);
    ...
    NOT_LP64(9);
    assert(UseCompressedClassPointers || offset() - start_offset == ic_cmp_size,
...
void C1_MacroAssembler::invalidate_registers(bool inv_rax, bool inv_rbx, bool inv_rcx, bool inv_rdx, bool inv_rsi,
                                             bool inv_rdi) {
#ifdef ASSERT

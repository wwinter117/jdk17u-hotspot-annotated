...
enum {
    pd_strict_fp_requires_explicit_rounding = LP64_ONLY(false)
    NOT_LP64 ( true )
};
...
#define UNALLOCATED 2    // rsp, rbp
    ...
    pd_nof_cpu_regs_frame_map - UNALLOCATED,  // number of registers killed by calls
    ...
    pd_first_cpu_reg = 0,
    pd_last_cpu_reg = NOT_LP64(5)
    LP64_ONLY(11),
    pd_first_byte_reg = NOT_LP64(2)
    LP64_ONLY(0),
    pd_last_byte_reg = NOT_LP64(5)
    LP64_ONLY(11),

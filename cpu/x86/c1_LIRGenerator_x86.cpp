...
#else
        case floatTag:
            opr = UseSSE >= 1 ? FrameMap::xmm0_float_opr : FrameMap::fpu0_float_opr;
            break;
        case doubleTag:
            opr = UseSSE >= 2 ? FrameMap::xmm0_double_opr : FrameMap::fpu0_double_opr;
            break;
#endif // _LP64
        case addressTag:
        default:
...
void LIRGenerator::cmp_reg_mem(LIR_Condition condition, LIR_Opr reg, LIR_Opr base, int disp, BasicType type,
                               CodeEmitInfo *info) {
...
LIR_Opr LIRGenerator::atomic_xchg(BasicType type, LIR_Opr addr, LIRItem &value) {
    ...
    assert(type == T_INT || is_oop
    LP64_ONLY( || type == T_LONG ), "unexpected type");
    ...
    switch (x->id()) {
        case vmIntrinsics::_dexp:
            if (StubRoutines::dexp() != NULL) {
                ...
                __ call_runtime_leaf(CAST_FROM_FN_PTR(address, SharedRuntime::dexp), getThreadTemp(), result_reg,
                                     cc->args());
            }
            break;
        case vmIntrinsics::_dlog:
            if (StubRoutines::dlog() != NULL) {
                ...
                __ call_runtime_leaf(CAST_FROM_FN_PTR(address, SharedRuntime::dlog), getThreadTemp(), result_reg,
                                     cc->args());
            }
            break;
        case vmIntrinsics::_dlog10:
            if (StubRoutines::dlog10() != NULL) {
                ...
                __ call_runtime_leaf(CAST_FROM_FN_PTR(address, SharedRuntime::dlog10), getThreadTemp(), result_reg,
                                     cc->args());
            }
            break;
        case vmIntrinsics::_dpow:
            if (StubRoutines::dpow() != NULL) {
                ...
                __ call_runtime_leaf(CAST_FROM_FN_PTR(address, SharedRuntime::dpow), getThreadTemp(), result_reg,
                                     cc->args());
            }
            break;
        case vmIntrinsics::_dsin:
            if (VM_Version::supports_sse2() && StubRoutines::dsin() != NULL) {
                ...
                __ call_runtime_leaf(CAST_FROM_FN_PTR(address, SharedRuntime::dsin), getThreadTemp(), result_reg,
                                     cc->args());
            }
            break;
        case vmIntrinsics::_dcos:
            if (VM_Version::supports_sse2() && StubRoutines::dcos() != NULL) {
                ...
                __ call_runtime_leaf(CAST_FROM_FN_PTR(address, SharedRuntime::dcos), getThreadTemp(), result_reg,
                                     cc->args());
            }
            break;
        case vmIntrinsics::_dtan:
            if (StubRoutines::dtan() != NULL) {
                ...
                __ call_runtime_leaf(CAST_FROM_FN_PTR(address, SharedRuntime::dtan), getThreadTemp(), result_reg,
                                     cc->args());
            }
            break;
        default:
...
void LIRGenerator::do_ArrayCopy(Intrinsic *x) {
    ...
    __ arraycopy(src.result(), src_pos.result(), dst.result(), dst_pos.result(), length.result(), tmp, expected_type,
                 flags, info); // does add_safepoint
}
...
LIR_Opr fixed_register_for(BasicType type) {
    switch (type) {
        case T_FLOAT:
            return FrameMap::fpu0_float_opr;
        case T_DOUBLE:
            return FrameMap::fpu0_double_opr;
        case T_INT:
            return FrameMap::rax_opr;
        case T_LONG:
            return FrameMap::long0_opr;
        default:
            ShouldNotReachHere();
            return LIR_OprFact::illegalOpr;
    }

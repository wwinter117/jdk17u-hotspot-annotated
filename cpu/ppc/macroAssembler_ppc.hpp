...
public:
    ...
    void call_VM(Register oop_result, address entry_point, Register arg_1, Register arg_2, Register arg3,
...
private:
    ...
    void cmpxchg_generic(ConditionRegister flag,
                         ...
                         int semantics, bool cmpxchgx_hint, Register int_flag_success, bool contention_hint, bool weak,
                         int size);
...
public:
    ...
    void getandsetb(Register dest_current_value, Register exchange_value, Register addr_base,
        ...
        atomic_get_and_modify_generic(dest_current_value, exchange_value, addr_base, tmp1, tmp2, tmp3, cmpxchgx_hint,
                                      false, 1);
    }
    ...
    void getandsetw(Register dest_current_value, Register exchange_value, Register addr_base,
                    bool cmpxchgx_hint) {
        atomic_get_and_modify_generic(dest_current_value, exchange_value, addr_base, noreg, noreg, noreg, cmpxchgx_hint,
                                      false, 4);
    }
    ...
    void getandaddb(Register dest_current_value, Register inc_value, Register addr_base,
                    Register tmp1, Register tmp2, Register tmp3, bool cmpxchgx_hint) {
        atomic_get_and_modify_generic(dest_current_value, inc_value, addr_base, tmp1, tmp2, tmp3, cmpxchgx_hint, true,
                                      1);
    }
    ...
    void getandaddw(Register dest_current_value, Register inc_value, Register addr_base,
        ...
        atomic_get_and_modify_generic(dest_current_value, inc_value, addr_base, tmp1, noreg, noreg, cmpxchgx_hint, true,
                                      4);
    }
...
public:
    ...
    void zap_from_to(Register low, int before, Register high, int after, Register val, Register addr)

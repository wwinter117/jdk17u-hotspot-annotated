...
int StubAssembler::call_RT(Register oop_result1, Register metadata_result,
    ...
    // Check for pending exceptions.
    {
        ...
        if (frame_size() == no_frame_size) {
            ...
            add_const_optimized(R0, R29_TOC, MacroAssembler::offset_to_global_toc(
                    Runtime1::entry_for(Runtime1::forward_exception_id)));
            mtctr(R0);
            bctr();
        }
...
int
StubAssembler::call_RT(Register oop_result1, Register metadata_result, address entry, Register arg1, Register arg2) {
    mr_if_needed(R4_ARG2, arg1);
    mr_if_needed(R5_ARG3, arg2);
    assert(arg2 != R4_ARG2, "smashed argument");
...
int StubAssembler::call_RT(Register oop_result1, Register metadata_result, address entry, Register arg1, Register arg2,
    ...
    mr_if_needed(R5_ARG3, arg2);
    assert(arg2 != R4_ARG2, "smashed argument");
    mr_if_needed(R6_ARG4, arg3);
    assert(arg3 != R4_ARG2 && arg3 != R5_ARG3, "smashed argument");
...
OopMapSet *Runtime1::generate_code_for(StubID id, StubAssembler *sasm) {
    ...
    switch (id) {
        ...
        case new_object_array_id: {
            ...
            if (id == new_type_array_id) {
                oop_maps = generate_stub_call(sasm, R3_RET, CAST_FROM_FN_PTR(address, new_type_array), R4_ARG2,
                                              R5_ARG3);
            } else {
                oop_maps = generate_stub_call(sasm, R3_RET, CAST_FROM_FN_PTR(address, new_object_array), R4_ARG2,
                                              R5_ARG3);
            }
        }
            break;
        ...
        case new_multi_array_id: {
            ...
            oop_maps = generate_stub_call(sasm, R3_RET, CAST_FROM_FN_PTR(address, new_multi_array), R4_ARG2, R5_ARG3,
                                          R6_ARG4);
        }
            break;
        ...
        case throw_range_check_failed_id: {
            ...
            oop_maps = generate_exception_throw_with_stack_parms(sasm,
                                                                 CAST_FROM_FN_PTR(address, throw_range_check_exception),
                                                                 2);
        }
            break;
        ...
        case slow_subtype_check_id: { // Support for uint StubRoutine::partial_subtype_check( Klass sub, Klass super );
            const Register sub_klass = R5,
                    super_klass = R4,
                    temp1_reg = R6,
                    temp2_reg = R0;
            __ check_klass_subtype_slow_path(sub_klass, super_klass, temp1_reg,
                                             temp2_reg); // returns with CR0.eq if successful
        ...
        case deoptimize_id: {
            ...
            oop_maps = stub_call_with_stack_parms(sasm, noreg, CAST_FROM_FN_PTR(address, deoptimize), 1, /*do_return*/
                                                  false);
        ...
        case dtrace_object_alloc_id: { // O0: object

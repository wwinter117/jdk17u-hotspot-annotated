...
void frame::patch_pc(Thread *thread, address pc) {
    ...
    if (TracePcPatching) {
        tty->print_cr("patch_pc at address "
        PTR_FORMAT
        " ["
        PTR_FORMAT
        " -> "
...
BasicType frame::interpreter_frame_result(oop *oop_result, jvalue *value_result) {
    ...
    if (method->is_native()) {
        ...
        switch (method->result_type()) {
            ...
            case T_BOOLEAN :
                value_result->z = (jboolean) * (unsigned long *) lresult;
                break;
            case T_INT     :
                value_result->i = (jint) * (long *) lresult;
                break;
            case T_CHAR    :
                value_result->c = (jchar) * (unsigned long *) lresult;
                break;
            case T_SHORT   :
                value_result->s = (jshort) * (long *) lresult;
                break;
            case T_BYTE    :
                value_result->z = (jbyte) * (long *) lresult;
                break;
            case T_LONG    :
                value_result->j = (jlong) * (long *) lresult;
                break;
            case T_FLOAT   :
                value_result->f = (jfloat) * (double *) fresult;
                break;
            case T_DOUBLE  :
                value_result->d = (jdouble) * (double *) fresult;
                break;
        ...
        switch (method->result_type()) {
            ...
            case T_BOOLEAN :
                value_result->z = (jboolean) * (jint *) tos_addr;
                break;
            case T_BYTE    :
                value_result->b = (jbyte) * (jint *) tos_addr;
                break;
            case T_CHAR    :
                value_result->c = (jchar) * (jint *) tos_addr;
                break;
            case T_SHORT   :
                value_result->s = (jshort) * (jint *) tos_addr;
                break;
            case T_INT     :

    ...
    switch (id) {
        ...
        case fast_new_instance_init_check_id: {
            ...
            if (!UseTLAB && Universe::heap()->supports_inline_contig_alloc() && id != new_instance_id) {
                ...
                __ eden_allocate(result, obj_end, tmp1, tmp2, obj_size,
                                 slow_case);        // initializes result and obj_end
        ...
        case new_object_array_id: {
            ...
            if (!UseTLAB && Universe::heap()->supports_inline_contig_alloc()) {
                ...
                __ initialize_object(result, obj_end, klass, length, tmp1, tmp2, tmp2, -1, /* is_tlab_allocated */
                                     false);
                __ raw_pop_and_ret(R4, R5);

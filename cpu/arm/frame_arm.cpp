...
BasicType frame::interpreter_frame_result(oop *oop_result, jvalue *value_result) {
    ...
    switch (type) {
        ...
        case T_BOOLEAN :
            value_result->z = *(jboolean *) res_addr;
            break;
        case T_BYTE    :
            value_result->b = *(jbyte *) res_addr;
            break;
        case T_CHAR    :
            value_result->c = *(jchar *) res_addr;
            break;
        case T_SHORT   :
            value_result->s = *(jshort *) res_addr;
            break;
        case T_INT     :
            value_result->i = *(jint *) res_addr;
            break;
        case T_LONG    :
            value_result->j = *(jlong *) res_addr;
            break;
        case T_FLOAT   :
            value_result->f = *(jfloat *) res_addr;
            break;
        case T_DOUBLE  :
            value_result->d = *(jdouble *) res_addr;
            break;

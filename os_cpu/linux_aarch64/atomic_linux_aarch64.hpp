...
inline D Atomic::PlatformAdd<4>::fetch_and_add(D volatile *dest, I add_value,
    ...
    switch (order) {
        case memory_order_relaxed:
            stub = aarch64_atomic_fetch_add_4_relaxed_impl;
            break;
        default:
            stub = aarch64_atomic_fetch_add_4_impl;
            break;
    }
...
inline D Atomic::PlatformAdd<8>::fetch_and_add(D volatile *dest, I add_value,
    ...
    switch (order) {
        case memory_order_relaxed:
            stub = aarch64_atomic_fetch_add_8_relaxed_impl;
            break;
        default:
            stub = aarch64_atomic_fetch_add_8_impl;
            break;
    }
    return atomic_fastcall(stub, dest, add_value);
}
...
inline T Atomic::PlatformCmpxchg<1>::operator()(T volatile *dest,
    ...
    switch (order) {
        case memory_order_relaxed:
            stub = aarch64_atomic_cmpxchg_1_relaxed_impl;
            break;
        default:
            stub = aarch64_atomic_cmpxchg_1_impl;
            break;
    }
...
inline T Atomic::PlatformCmpxchg<4>::operator()(T volatile *dest,
    ...
    switch (order) {
        case memory_order_relaxed:
            stub = aarch64_atomic_cmpxchg_4_relaxed_impl;
            break;
        case memory_order_release:
            stub = aarch64_atomic_cmpxchg_4_release_impl;
            break;
        case memory_order_acq_rel:
        case memory_order_seq_cst:
            stub = aarch64_atomic_cmpxchg_4_seq_cst_impl;
            break;
        default:
...
inline T Atomic::PlatformCmpxchg<8>::operator()(T volatile *dest,
    ...
    switch (order) {
        case memory_order_relaxed:
            stub = aarch64_atomic_cmpxchg_8_relaxed_impl;
            break;
        case memory_order_release:
            stub = aarch64_atomic_cmpxchg_8_release_impl;
            break;
        case memory_order_acq_rel:
        case memory_order_seq_cst:
            stub = aarch64_atomic_cmpxchg_8_seq_cst_impl;
            break;
        default:
            stub = aarch64_atomic_cmpxchg_8_impl;
            break;
    }

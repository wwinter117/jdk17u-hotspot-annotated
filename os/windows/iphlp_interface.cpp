...
*GetIfTable2_Fn)(PMIB_IF_TABLE2*);
typedef DWORD(WINAPI
*FreeMibTable_Fn)(PVOID);
...
void IphlpDll::initialize(void) {
    ...
    _GetIfTable2 = (GetIfTable2_Fn)
    ::GetProcAddress(_hModule, "GetIfTable2");
    _FreeMibTable = (FreeMibTable_Fn)
    ::GetProcAddress(_hModule, "FreeMibTable");

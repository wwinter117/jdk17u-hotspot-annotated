...
private:
    ...
    static PDH_STATUS (WINAPI
    *_PdhAddCounter)(HQUERY, LPCSTR, DWORD, HCOUNTER*);
    static PDH_STATUS (WINAPI
    *_PdhOpenQuery)(LPCWSTR, DWORD, HQUERY*);
    static DWORD      (WINAPI
    *_PdhCloseQuery)(HQUERY);
    static PDH_STATUS (WINAPI
    *_PdhCollectQueryData)(HQUERY);
    static DWORD      (WINAPI
    *_PdhGetFormattedCounterValue)(HCOUNTER, DWORD, LPDWORD, PPDH_FMT_COUNTERVALUE);
    static PDH_STATUS (WINAPI
    *_PdhEnumObjectItems)(LPCTSTR, LPCTSTR, LPCTSTR, LPTSTR, LPDWORD, LPTSTR, LPDWORD, DWORD, DWORD);
    static PDH_STATUS (WINAPI
    *_PdhRemoveCounter)(HCOUNTER);
    static PDH_STATUS (WINAPI
    *_PdhLookupPerfNameByIndex)(LPCSTR, DWORD, LPSTR, LPDWORD);
    static PDH_STATUS (WINAPI
    *_PdhMakeCounterPath)(PPDH_COUNTER_PATH_ELEMENTS, LPTSTR, LPDWORD, DWORD);
    static PDH_STATUS (WINAPI
    *_PdhExpandWildCardPath)(LPCSTR, LPCSTR, PZZSTR, LPDWORD, DWORD);

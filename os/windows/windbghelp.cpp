...
*pfn_SymSetOptions)(DWORD);
typedef DWORD (WINAPI
*pfn_SymGetOptions)(void);
typedef BOOL  (WINAPI
*pfn_SymInitialize)(HANDLE, PCTSTR, BOOL);
typedef BOOL  (WINAPI
*pfn_SymGetSymFromAddr64)(HANDLE, DWORD64, PDWORD64, PIMAGEHLP_SYMBOL64);
typedef DWORD (WINAPI
*pfn_UnDecorateSymbolName)(const char*, char*, DWORD, DWORD);
typedef BOOL  (WINAPI
*pfn_SymSetSearchPath)(HANDLE, PCTSTR);
typedef BOOL  (WINAPI
*pfn_SymGetSearchPath)(HANDLE, PTSTR, int);
typedef BOOL  (WINAPI
*pfn_StackWalk64)(
DWORD MachineType,
        HANDLE
...
HANDLE hProcess, DWORD64
AddrBase);
typedef DWORD64 (WINAPI
*pfn_SymGetModuleBase64)(
HANDLE hProcess, DWORD64
dwAddr);
typedef BOOL (WINAPI
*pfn_MiniDumpWriteDump) (
...
typedef BOOL (WINAPI
*pfn_SymGetLineFromAddr64) (
HANDLE hProcess, DWORD64
dwAddr,
PDWORD pdwDisplacement, PIMAGEHLP_LINE64
Line);
typedef LPAPI_VERSION (WINAPI
*pfn_ImagehlpApiVersion)(void);
...
BOOL WindowsDbgHelp::symInitialize(HANDLE
hProcess,
PCTSTR UserSearchPath, BOOL
fInvadeProcess) {
WindowsDbgHelpEntry entry_guard;
if (g_pfn_SymInitialize != NULL) {
return
g_pfn_SymInitialize(hProcess, UserSearchPath, fInvadeProcess
);
}
return
FALSE;
...
BOOL WindowsDbgHelp::symGetSymFromAddr64(HANDLE
hProcess,
DWORD64 the_address,
        PDWORD64
Displacement,
...
return
g_pfn_SymGetSymFromAddr64(hProcess, the_address, Displacement, Symbol
);
}
return
FALSE;
...
BOOL WindowsDbgHelp::symSetSearchPath(HANDLE
hProcess,
PCTSTR SearchPath
) {
WindowsDbgHelpEntry entry_guard;
...
return
g_pfn_SymSetSearchPath(hProcess, SearchPath
);
}
return
FALSE;
...
BOOL WindowsDbgHelp::symGetSearchPath(HANDLE
hProcess,
PTSTR SearchPath,
...
return
g_pfn_SymGetSearchPath(hProcess, SearchPath, SearchPathLength
);
}
return
FALSE;
...
BOOL WindowsDbgHelp::stackWalk64(DWORD
MachineType,
HANDLE hProcess,
        HANDLE
hThread,
...
PVOID WindowsDbgHelp::symFunctionTableAccess64(HANDLE
hProcess,
DWORD64 AddrBase
) {
WindowsDbgHelpEntry entry_guard;
...
return
g_pfn_SymFunctionTableAccess64(hProcess, AddrBase
);
}
return
NULL;
...
DWORD64 WindowsDbgHelp::symGetModuleBase64(HANDLE
hProcess,
DWORD64 dwAddr
) {
WindowsDbgHelpEntry entry_guard;
...
return
g_pfn_SymGetModuleBase64(hProcess, dwAddr
);
}
return 0;
}

BOOL WindowsDbgHelp::miniDumpWriteDump(HANDLE
hProcess,
...
return
g_pfn_MiniDumpWriteDump(hProcess, ProcessId, hFile, DumpType,
...
BOOL WindowsDbgHelp::symGetLineFromAddr64(HANDLE
hProcess,
DWORD64 dwAddr,
        PDWORD
pdwDisplacement,
...
return
g_pfn_SymGetLineFromAddr64(hProcess, dwAddr, pdwDisplacement, Line
);
}
return
FALSE;
